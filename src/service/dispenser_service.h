...
struct coffee_dispenser_service {
  ...
  coffee_machine_snapshot_t (*machine_snapshot)(
      coffee_dispenser_service_t *service);
  bool (*can_dispense)(coffee_dispenser_service_t *service,
                       const coffee_beverage_t *beverage, const char **reason);
  bool (*start)(coffee_dispenser_service_t *service,
                const coffee_beverage_request_t *request, const char **error);
  bool (*cancel)(coffee_dispenser_service_t *service);
  coffee_dispense_snapshot_t (*dispense_snapshot)(
      coffee_dispenser_service_t *service);
