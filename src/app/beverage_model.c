...
static const coffee_beverage_t beverages[] = {
    {COFFEE_BEV_COFFEE, "coffee", "Coffee", "C", COFFEE_CATEGORY_COFFEE, 180,
     120, 240, 28,
     COFFEE_RESOURCE_WATER | COFFEE_RESOURCE_BEANS | COFFEE_RESOURCE_HEATER |
         COFFEE_RESOURCE_GRINDER,
     size_options, 3},
    {COFFEE_BEV_ESPRESSO, "espresso", "Espresso", "E", COFFEE_CATEGORY_COFFEE,
     40, 30, 80, 22,
     COFFEE_RESOURCE_WATER | COFFEE_RESOURCE_BEANS | COFFEE_RESOURCE_HEATER |
         COFFEE_RESOURCE_GRINDER,
     espresso_options, 2},
    {COFFEE_BEV_LATTE_MACCHIATO, "latte_macchiato", "Latte Macchiato", "L",
     COFFEE_CATEGORY_MILK, 250, 220, 300, 42,
     COFFEE_RESOURCE_WATER | COFFEE_RESOURCE_BEANS | COFFEE_RESOURCE_MILK |
         COFFEE_RESOURCE_HEATER | COFFEE_RESOURCE_GRINDER,
     milk_options, 3},
    {COFFEE_BEV_CAPPUCCINO, "cappuccino", "Cappuccino", "M",
     COFFEE_CATEGORY_MILK, 180, 160, 240, 34,
     COFFEE_RESOURCE_WATER | COFFEE_RESOURCE_BEANS | COFFEE_RESOURCE_MILK |
         COFFEE_RESOURCE_HEATER | COFFEE_RESOURCE_GRINDER,
     milk_options, 3},
    {COFFEE_BEV_AMERICANO, "americano", "Americano", "A",
     COFFEE_CATEGORY_COFFEE, 200, 140, 300, 30,
     COFFEE_RESOURCE_WATER | COFFEE_RESOURCE_BEANS | COFFEE_RESOURCE_HEATER |
         COFFEE_RESOURCE_GRINDER,
     size_options, 3},
    {COFFEE_BEV_HOT_WATER, "hot_water", "Hot Water", "W", COFFEE_CATEGORY_WATER,
     200, 100, 300, 18, COFFEE_RESOURCE_WATER | COFFEE_RESOURCE_HEATER,
     water_options, 3},
};
...
static uint16_t resolve_volume(const coffee_beverage_t *beverage,
                               coffee_beverage_option_t option) {
  switch (option) {
  case COFFEE_OPTION_SIZE_SMALL:
...
bool coffee_beverage_make_request(coffee_beverage_id_t id,
                                  coffee_beverage_option_t option,
  ...
  uint16_t time = (uint16_t)(beverage->default_time_s +
                             ((volume > beverage->default_volume_ml) ? 4 : 0));
  out->beverage_id = id;
  out->option = option;
